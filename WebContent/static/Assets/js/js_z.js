$(function(){
	$('.pro_l li:nth-child(4n)').css('margin-right',0+'px');
	$('.cc .xz_z').click(function(){
		$(this).siblings('ul').slideDown();
	});
	$('.cc ul li').click(function(){
		var l_z=$(this).html();
		$(this).parent('ul').siblings('.xz_z').children('span').html(l_z);
		$(this).parent('ul').slideUp();
	});
	$('.search_m table tr:nth-child(2n+1)').children('td').css('background','#dfdfdf');
});
//幻灯片
; (function ($) {
    $.fn.extend({
